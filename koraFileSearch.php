...
require_once("includes/clientUtilities.php");
        ...
        <form method="POST" action="koraFileSearch.php">            
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="query" size="30" value="<?php if (isset($_POST["query"])) echo $_POST["query"];?>">
                    </td>
                </tr>
...
if ( $query != null && @$solr_enabled )
{
    ...
    $query = urlencode(addslashes($_POST["query"]));
