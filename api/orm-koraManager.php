...
class KoraManager
{
	 ...
	 * a new KoraEntity.
	 * 
	 * If some data is specifiec, then the KoraEntity which is created with
	 ...
	 */
	public function search($projectID, $schemeID, $queryClause, $orderBy=array(), $limitStart=0, $limitNum=0)
	{
		$results = KORA_Search($this->searchToken, $projectID, $schemeID, $queryClause, 'ALL', $orderBy, $limitStart, $limitNum);
		$entities = array();
