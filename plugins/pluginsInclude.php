...
print "<link type='text/css' rel='stylesheet' href='".baseUrlPlugin."css/all.css'>"."\n";
print "<link type='text/css' rel='stylesheet' href='".baseUrlPlugin."includes/thickbox/thickbox.css'>"."\n";
print "<script type='text/javascript' src='//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js'></script>"."\n";
print '<script type="text/javascript" src="'.baseUrlPlugin.'javascripts/gettext.js.php"></script>'."\n";
print '<script type="text/javascript" src="'.baseUrlPlugin.'includes/thickbox/thickbox.js" ></script>'."\n";
//print '<script type="text/javascript" src="'.baseUrlPlugin.'javascripts/common.js"></script>'."\n";
print '<script type="text/javascript" src="'.baseUrlPlugin.'javascripts/plugins.js"></script>'."\n";
print "<link type='text/css' rel='stylesheet' href='".baseUrlPlugin."css/default.css'>"."\n";
