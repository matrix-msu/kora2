...
define('KORA_VERSION', '2.2.0');
define('LATEST_DB_VERSION', '2.2.0');

//reCAPTCHA keys, used for public ingestion
define('PUBLIC_KEY', '6Lf8dAkAAAAAAG14cn2CzlrjQQuAEE-7yl5268SY');
define('PRIVATE_KEY','6Lf8dAkAAAAAABiuNhKqqKPuCzsB1la9Lsa8cimE');
