...
if(isset($_POST['action']) && isset($_POST['source']) && $_POST['source'] == 'SearchTokenFunctions')
{
    $action = $_POST['action'];
    ...
    elseif($action == 'deleteToken')
        deleteToken($_POST['tokenid']);
    elseif($action == 'addAccess')
        addAccess($_POST['tokenid'], $_POST['pid']);
    elseif($action == 'removeAccess')
        removeAccess($_POST['tokenid'], $_POST['pid']);        
}
?>